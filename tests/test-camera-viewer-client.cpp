...
void
visualizeImageData (const PeerMode *peerMode)
{
  void *context;
  void *consumer;
      ...
      if (localDataBuffer != NULL)
        {
          ...
          memcpy (localDataBuffer, zmq_msg_data (&repMsg) + 2 * sizeof (uint32_t), 614400);
...
void
generateImageData (const PeerMode *peerMode)
{
...
int
parseOptions (int argc, char *argv[], struct PeerMode *peerMode)
{
